            ...
            <div className="discription">
                <div className="citizen">
                    ...
                    <ul>
                        ...
                        <li>
                            <span className="expresive-text">Suivez</span> des politiciens local et regionaux partout en
                            France
                        </li>
                        <li>
                            <span className="expresive-text">Informez</span> vous sur leur idées et programmes electoral
                        </li>
                    </ul>
                ...
                <div className="politician">
                    ...
                    <ul>
                        ...
                        <li>
                            <span className="expresive-text">Découvrez</span> les problématiques que rencontre les
                            citoyens
                        </li>
                    </ul>
